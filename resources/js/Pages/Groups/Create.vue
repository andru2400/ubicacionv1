        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">  
                        ...
                        <div class="shadow bg-white md:rounded-md p-4">
                            <form @submit.prevent="submit">
                                ...
                                <select class="w-full border bg-white rounded px-3 py-2 outline-none" v-model="form.group_dependent_id">
                                    <option class="py-1" disabled :value="''">Ninguno</option>                                    
                                    <option class="py-1" v-for="group in groups" :key="group.id" v-text="group.key"></option>                                    
                                </select>
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6 my-4" v-if="checkValues">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px0">
                            <h3 class="text-lg text-gray-900">Agregar Parametros</h3>
                            <p class="text-sm text-gray-600">Ingresa los parametros ligados</p>
                        </div>
                    </div>
                    <div class="md:col-span-2 mt-5 md:mt-0">
                        <div class="shadow bg-white md:rounded-md p-4">
                                ...
                                <table class="rounded-t-lg m-5 w-5/6 mx-auto bg-gray-200 text-gray-800">
                                    ...
                                    <tr v-for="parameter in parameters" :key="parameter" class="bg-gray-100 border-b border-gray-200">
    ...
    export default {
        ...
        methods: {
            ...
            addItem(){
                var arrayTemp = {
                                    "value": tempValue,
                                    "parameter_dependent_id": tempDependent,
                                };
				this.element.values.push(arrayTemp);
            }
        }
    }
</script>
